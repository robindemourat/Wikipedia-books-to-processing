//starter verne
//par où commencer pour le poulpe :
// https://processing.org/examples/chain.html
...
void setup() {
  ...
  donnees = loadJSONObject("verne_data.json");
  //pour ce starter, on choisit un seul chapitre du texte
  JSONArray texte = donnees.getJSONArray("content")//nous donne l
    .getJSONObject(0)//on choisit le premier chapitre
      .getJSONArray("content")//nous donne la liste des chapitres de cette partie
